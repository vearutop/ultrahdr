...
## Legacy Adobe Camera Raw XMP

Older ACR exports may store gainmap fields using `<rdf:Seq>` elements instead of XMP
attributes. The parser supports both formats.

For closer parity with the C++ implementation (gamut conversion, ICC, advanced sampling, LUTs), additional work is needed.
